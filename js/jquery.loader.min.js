...
"z-index":"1"},overflow:{background:"#aeaeae",opacity:"0.4"}}},f={initialized:!1,init:function(){var a=this,c=["container","gif","overflow"];b.each(c,function(e,d){a[d]=b("<div>",{"class":"loader_"+d});0<e&&a[c[0]].append(a[d])});a.initialized=!0;return a},append_to:function(a){a.append(this.container);return this},show:function(a,c){var e=b.extend(a.offset(),{width:a.outerWidth(),height:a.outerHeight()}),d=a.data("loader_settings")||c;this.container.css(b.extend({},d.css.container,e));this.overflow.css(b.extend({},
d.css.overflow,e));this.gif.css(d.css.gif).css({top:(e.height-parseInt(this.gif.css("height"),10))/2,left:(e.width-parseInt(this.gif.css("width"),10))/2});return this.container.css("display","block")},hide:function(){return this.container.css("display","none")}};b.fn.Loader=function(a){var c=b.extend({},g);f.initialized||f.init().append_to(b("body"));if(a===Object(a)||!a)return this.each(function(){b(this).data("loader_settings",b.extend(!0,c,a||{}))});if("show"===a||"hide"===a)f[a](b(this[0]),c);
return this}})(jQuery);